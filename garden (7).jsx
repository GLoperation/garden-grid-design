...
const PLANTS = [
  ...
  { id:"fennel_h",name:"Herb Fennel",cat:"Herb",spacingIn:12,sun:"Full",water:"Regular",days:"60–90",depth:"¼″",season:"Cool",heightIn:48,zones:[4,10],sow:"direct",companions:[],avoid:["Most plants"],color:"#c6f6d5",icon:"dill",tip:"Direct sow. ALLELOPATHIC — releases chemicals that inhibit growth of nearby plants. Plant in isolated area or its own container. Fronds, seeds, and pollen all edible. Bronze fennel is ornamental variety. Attracts swallowtail butterflies. Different from bulb fennel (Florence)." },
